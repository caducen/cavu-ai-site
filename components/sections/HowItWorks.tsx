      ...
      <div className="relative mx-auto flex max-w-5xl flex-col gap-12 rounded-3xl border border-white/10 bg-black/50 px-6 py-10 text-center shadow-lg shadow-black/40 backdrop-blur">
        <div className="space-y-4">
          ...
          <h2 className="text-balance text-3xl font-semibold text-white md:text-4xl">
            Map critical opportunities, design resilient systems, and launch with confidence.
          </h2>
          <p className="mx-auto max-w-2xl text-base text-gray-200">
            Each engagement follows a proven blueprint that keeps stakeholders aligned, risks visible, and delivery velocity high.
          </p>
        </div>
        <div className="relative mx-auto grid max-w-4xl gap-6 md:grid-cols-3">
          ...
          {processSteps.map((step, idx) => {
            ...
            return (
              ...
              >
                <div className="absolute inset-0 -z-10 opacity-10 transition duration-500 group-hover:opacity-30" style={{
                  background:
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-semibold text-gray-400">Step {idx + 1}</span>
                </div>
