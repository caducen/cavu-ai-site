      ...
      <div className="relative mx-auto flex max-w-4xl flex-col gap-10 rounded-3xl border border-white/10 bg-black/50 px-6 py-10 text-center shadow-lg shadow-black/40 backdrop-blur">
        <div className="space-y-4">
          ...
          <h2 className="text-balance text-3xl font-semibold text-white md:text-4xl">
            Clarity at every step—from kickoff to long-term optimization.
          </h2>
          <p className="mx-auto max-w-2xl text-base text-gray-200">
            If you have additional questions, we are an email or call away. Here are answers to the topics leaders ask most.
          </p>
        </div>
        <motion.div
